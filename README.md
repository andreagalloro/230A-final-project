...
I used the instructions at this link to run jupyter notebooks on a compute node in the SCF: [Connect to an SCF Cluster Node](https://computing.stat.berkeley.edu/access/vscode-remote-ssh/#connect-to-an-scf-cluster-node)
